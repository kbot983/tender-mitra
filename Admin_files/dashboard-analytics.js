...
//Fetching data from fetch-request-data.php
var countArray = [];


(function(window, document, $) {
   $.post("http://localhost/php_functions/fetch-request-data.php", function(data){
      ...
      for(var element in response){
         countArray.push(response[element]);
   ...
   var revenueLineChartData = {
      labels: ["Setting", "Search", "Bidding", "Payment", "Status", "Technical"],
      datasets: [
         {
            label: "Today",
            data: countArray,//[100, 50, 20, 40, 80, 50, 80],
